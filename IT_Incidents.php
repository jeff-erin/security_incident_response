...
<body>
	...
	<div class="nav">
		<a href='https://localhost/SeniorProject/html/IT_Home.html'>Home</a>
  		<a class="selected" href='https://localhost/SeniorProject/html/IT_Incidents.html'>Open Incidents</a>
	...
	<div  class="open">
		...
		<table>
			...
			$sql = "SELECT ticket_id, user_id, date_created, Details, Classification FROM ticket WHERE it_sec_id = '$sid' AND isOpen = 1";
	...
	<div class="open">
		...
		<table>
			...
			<?php
			$sql = "SELECT ticket_id, user_id, date_created, Details, Classification FROM ticket WHERE isOpen = 1";
